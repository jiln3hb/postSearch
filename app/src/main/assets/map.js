function outError(value) {
    document.getElementById('alert1').append(value + ' ');
...
function addStartMarker(latlng) {
    ...
    map.setView([marker2._latlng.lat, marker2._latlng.lng], 14);
}
